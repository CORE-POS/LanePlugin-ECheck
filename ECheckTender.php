...
class ECheckTender extends TenderModule 
{
    ...
    public function preReqCheck()
    {
        ...
        */
        if (CoreLocal::get('msgrepeat') == 0) {
            ...
            $plugin_info = new ECheck();
            return $plugin_info->pluginUrl() . '/ECheckVerifyPage.php?amount='.$this->amount;;
        } elseif (CoreLocal::get('msgrepeat') == 1 && CoreLocal::get('lastRepeat') == 'echeckVerifyType') {
    ...
    */
    protected function endorsing()
    {
        ...
        return MiscLib::baseURL().'gui-modules/boxMsg2.php?endorse=check&endorseAmt='.$this->amount;
    }
